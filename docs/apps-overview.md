...
| `low-priority` | 100000 | servarr services, bin-scraper, arpwatch, jellyfin, navidrome, jellyseerr, seerr, plex, pve-exporter, forgejo-runner, renovate, datasette |
