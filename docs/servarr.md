...
**Depth:** **Reference**
**Read this when:** working on Transmission, Sonarr, Radarr, Prowlarr, Bazarr, or Overseerr.
**Read instead:** [nas-k3s.md](nas-k3s.md) for NAS scheduling constraints these services share.
...
`apps/servarr/downloads-janitor/` is a daily CronJob (02:25, `k3s-nas`) that finds — and, once
