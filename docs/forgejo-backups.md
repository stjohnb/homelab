...
**Deep dive.** Read this when restoring Forgejo from backup or changing the local/offsite backup CronJobs. For Forgejo's general architecture, see [forgejo.md](forgejo.md).
