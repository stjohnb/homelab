...
**Reference.** Read this when working on Flux's Slack alerting or Grafana deployment annotations. For CronJob-specific alert rules, see [monitoring.md](monitoring.md).
