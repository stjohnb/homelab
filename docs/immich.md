...
**Reference.** Read this when working on Immich (photo management), its pod architecture, or its database backups. For the shared Postgres instance, see [postgres.md](postgres.md).
