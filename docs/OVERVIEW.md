...
- [Shared PostgreSQL](postgres.md) — The single `apps/postgres` instance behind Authentik, Immich, Garden, Forgejo and Claws: image choice, adding a database, NetworkPolicy allow-list, backups
