...
**Deep dive.** Read this when you need the history of why Plex/Jellyfin run on `k3s` behind soft NFS instead of the NAS node, or are repeating a similar cutover. For current NAS node behaviour, see [nas-k3s.md](nas-k3s.md).
