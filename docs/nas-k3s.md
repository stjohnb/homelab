...
**Depth:** **Reference**
**Read this when:** working on the NAS worker node, NFS mounts, or NAS-offline behaviour.
**Read instead:** [nas-app-tier-migration.md](nas-app-tier-migration.md) for the Plex/Jellyfin exception.
