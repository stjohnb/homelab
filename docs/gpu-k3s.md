...
**Reference.** Read this when working on the GPU worker node, NVIDIA device plugin, or GPU-pinned services (Ollama, Whisper). For NFS/storage node scheduling, see [nas-k3s.md](nas-k3s.md).
